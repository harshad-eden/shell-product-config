const currentImports = {};
      ...
      let moduleMap = {
"./App":()=>{
      dynamicLoadingCss(["style-Xbl_o9JS.css"], false, './App');
      return __federation_import('./__federation_expose_App-XpIHoOV1.js').then(module =>Object.keys(module).every(item => exportSet.has(item)) ? () => module.default : () => module)},};
      const seen = {};
